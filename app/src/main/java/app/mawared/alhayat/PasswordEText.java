...
public class PasswordEText extends EditText {
    ...
    public PasswordEText(Context context) {
        super(context);
        init(null);
    }

    public PasswordEText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public PasswordEText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private boolean isLeftToRight() {
        ...
        return true;//!(config.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL);
    }
